...
> Source: https://help.qsys.com/Content/Schematic_Library/Attero_Tech_extension_unDX4I.htm

# Attero Tech unDX4I

Use this extension to connect to and control a unDX4I Dante network audio wall plate 4x2 mic/line I/O (Attero Tech by QSC).

**Note:** See the [unDX4I product page](https://www.qsys.com/systems/products/q-sys-ecosystem/products-peripherals-accessories/attero-tech/at-wall-mount-network-audio-interfaces/undx4i/?L=) on the QSC website for product information and documentation.

[Compatibility](javascript:void(0))

The extension is compatible with Q-SYS Designer version 8.4 and above and Attero Tech firmware version 4.5.0 and above.
...
2. In the Unit/IP field, specify the IP address of the device and press Enter.

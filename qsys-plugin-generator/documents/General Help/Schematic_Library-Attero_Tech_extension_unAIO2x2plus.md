...
> Source: https://help.qsys.com/Content/Schematic_Library/Attero_Tech_extension_unAIO2x2plus.htm

# Attero Tech unAIO2x2+

Use this extension to connect to and control the unAIO2x2+ AES67 2-in/2-out I/O interface (Attero Tech by QSC).
...
Select the gain level for the input:
...
| Input Gain | | | | |
| 1, 2 | - | Line (0 dB)  +15 dB  Low Mic (+30dB)  High Mic (+45dB) | - | Input / Output |
| Input Pad | | | | |

...
> Source: https://help.qsys.com/Content/Schematic_Library/io_cobranet_output_card_core.htm
...
When the CobraNet Out component is selected in the Schematic, you will see all of the Properties of the Core or I/O Frame in which it is installed. Under the I/O Frame slot in which the card is installed, or under the Core I/O Slot, you can set the Input and Output Counts for the CobraNet card.

...
> Source: https://help.qsys.com/Content/Reflect/Core_Management/Users.htm
...
**Note:** Local users on the Core are not the same as Q-SYS Reflect users. To learn about Reflect users, see [Reflect Users and Roles](../Reflect_Sites/Users_Roles.htm).

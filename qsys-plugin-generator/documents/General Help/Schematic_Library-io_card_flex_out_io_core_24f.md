# Flex Out (I/O-Core 24f)

> Source: https://help.qsys.com/Content/Schematic_Library/io_card_flex_out_io_core_24f.htm

# Flex Out (I/O-Core 24f)

The Flex Channel feature on the I/O-Core 24f provides eight audio channels that can be individually switched between mic/line inputs and line outputs. The Flex Out Component provides the control and selection of the line-level outputs on the processor. The Flex Out Component converts the processed digital signal to analog and provides software controls before and after the convertor. Connections are made using three-terminal 3.5mm Euro style connectors.
...
| Max Level | -40 to 20 | -40.0 to 20 | 0 to .988 | Input / Output |

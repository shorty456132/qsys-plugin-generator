...
> Source: https://help.qsys.com/Content/Hardware/IO_Expanders/QIO-AES8x8.htm

# QIO-AES8x8

The Q-SYS QIO-AES8x8 is a network audio endpoint native to the Q-SYS Ecosystem, serving as an AES3 input/output device, that enables network-based audio distribution. The compact form factor includes surface mounting hardware permitting discreet and strategic mounting while an optional rack kit fits one to four devices into a standard 1U nineteen-inch format. The eight-channel granularity locates the right amount of connectivity in desired locations without bulk or waste. Up to four devices may be daisy-chained off one access switch port, provided +24 VDC power is available. Alternatively, each may be individually powered over Ethernet.

**Note:** This topic provides an overview of the QIO-AES8x8. For specifications and installation documentation, see the [QIO Series Network Audio Expanders product page](https://www.qsys.com/products-solutions/q-sys/audio-io-peripherals/qio/) on the QSC website.
...
These Inventory components are available for the QIO-AES8x8:

* [Status (NL Series, NM Series, QIO Series)](../../Schematic_Library/lcqln_status.htm)
* [AES3 In (QIO Series)](../../Schematic_Library/lcqln_aes3_in.htm)
* [AES3 Out (QIO Series)](../../Schematic_Library/lcqln_aes3_out.htm)

[Connections and Callouts](javascript:void(0))

### Front Panel

1. Power LED â Illuminates blue when the Q-SYS QIO-AES8x8 is powered on.
2. ID LED â LED blinks green when placed into ID Mode via ID Button or Q-SYS Configurator.
3. ID Button â Locates the QIO-AES8x8 in Q-SYS Designer Software and Q-SYS Configurator.
...
3. LAN [PoE] â RJ-45 connector, 802.3af Type 1 Class 2 power, Q-LAN.
...
6. AES Outputs â Eight channels, balanced, multiple sample rates.
7. AES Inputs â Eight channels, balanced, multiple sample rates.

[Specifications and Dimensions](javascript:void(0))

Product specifications and dimension drawings for the QIO-AES8x8 can be found on the [QIO Series Network Audio Expanders product page](https://www.qsys.com/products-solutions/q-sys/audio-io-peripherals/qio/).

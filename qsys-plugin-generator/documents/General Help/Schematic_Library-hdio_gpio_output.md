...
> Source: https://help.qsys.com/Content/Schematic_Library/hdio_gpio_output.htm

# GPIO Out (QIO Series)

Some Q-SYS QIO devices have General Purpose Output pins for extension of Q-SYS Control to third-party devices. In the Q-SYS Designer Software component properties, you can configure the output signal type for each pin â digital, open collector, or raw.

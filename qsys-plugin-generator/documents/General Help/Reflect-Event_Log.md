...
> Source: https://help.qsys.com/Content/Reflect/Event_Log.htm
...
**Note:**  Q-SYS Reflect retains up to 6 months of archived events or a maximum of 30,000 logged events, with the oldest events removed to make room for new events.
...
QSC-authored plugins installed from Q-SYS Library.
...
To clear the event log for this Core, click Clear Events. This permanently deletes all Event Log data from Q-SYS Reflect. Only Administrators can clear Event Log data.

...
> Source: https://help.qsys.com/Content/Schematic_Library/io_core_nano_status.htm
...
Use Q-SYS Core Manager to switch a Q-SYS Core Nano to I/O-Core Nano mode. For more information, see [Utilities](../Core_Manager/Core_Management/Utilities.htm) in the Core Manager Help.

**Note:** After switching to I/O-Core Nano mode, use Q-SYS Configurator (within Q-SYS Designer Software) to discover and configure the device within the I/O Devices category. Selecting the I/O-Core Nano opens [Peripheral Manager](../Peripheral_Manager/PeripheralManager_Overview.htm), which you can also use to change the mode back to Core Nano mode.
...
| Details | (text) | | | Output |
| I/O-Core Nano Status | 0  1  2  3  4  5 | OK (Green)  Compromised (Orange)  Fault (Red)  Not Present (Gray)  Missing (Red)  Initializing (Blue) | - | Output |

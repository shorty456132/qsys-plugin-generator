...
> Source: https://help.qsys.com/Content/Core_Manager/Resources/MiniTopics/DateTimeSpecifiers.htm

#### Video Endpoints > Idle Screen > Date Format String Specifiers

Use these specifiers when creating a custom [Video > Video Endpoints](../../System_Management/Video_Endpoints.htm) > Idle Screen date and time format string.
...
| %P | Lowercase âamâ or âpmâ |
| %p | Uppercase âAMâ or âPMâ |
| %R | Equivalent to "%H:%M" |

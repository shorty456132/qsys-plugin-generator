...
> Source: https://help.qsys.com/Content/Reflect/System_Management/Dynamic_Pairing.htm
...
* If a device is configured for redundancy, it cannot be dynamically paired.
...
3. In Q-SYS Reflect, first select a System, and then select Dynamic Pairing. All devices configured for Dynamic Pairing are listed.
4. Click Edit.

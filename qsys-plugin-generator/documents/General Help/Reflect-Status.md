...
> Source: https://help.qsys.com/Content/Reflect/Status.htm
...
Click to disallow the System from reporting its status to the Alerts table. For more information, see [Alerts & Notifications](Alerts.htm).

#### Notes and Attachments

Click Edit to type any descriptive notes about the System, as well as attach reference files (up to 50 MB total). Click  to upload files. Attachments might include System drawings, images, documentation, etc.

**Tip:** Any notes or attachments are also visible from the Systems page. From the Notes column, click the  icon to quickly view any uploaded notes and attachments.
...
To learn how to configure and link Presets, see the [Presets](Reflect_Sites/Presets.htm) topic.
...
Click to unregister this Core from Q-SYS Reflect. The Core can no longer be monitored remotely from Q-SYS Reflect.

**CAUTION:** When you unregister a Core, all data associated with that Core is removed from Q-SYS Reflect.
...
Click Pause to disallow an individual inventory item from reporting its status to the Alerts table. For more information, see [Alerts & Notifications](Alerts.htm).

**Note:** Inventory status is not available for Basic tier subscriptions.

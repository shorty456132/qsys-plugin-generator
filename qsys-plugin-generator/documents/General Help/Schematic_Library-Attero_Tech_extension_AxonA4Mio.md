# Attero Tech Axon A4Mio

> Source: https://help.qsys.com/Content/Schematic_Library/Attero_Tech_extension_AxonA4Mio.htm

# Attero Tech Axon A4Mio

Use this extension to connect to and control the Axon A4Mio AES67 network audio I/O endpoint (Attero Tech by QSC).

**Note:** See the [Axon A4Mio product page](https://www.qsys.com/systems/products/q-sys-ecosystem/products-peripherals-accessories/attero-tech/at-surface-mount-network-audio-interfaces/axon-a4mio/) on the QSC website for product information and documentation.
...
The controls in this section relate to the four analog inputs on the A4Mio.
...
Controls in this section relate to the four analog outputs on the A4Mio.
...
| Gain | | | | |
| 1-4 | -8 to 36 | -8dB to 36dB | 0.00 to 1.00 | Input / Output |
| Meter | | | | |
...
| 1-4 | 0  1 | false  true | 0  1 | Output |
| Gain |  | | | |
| 1-4 | 0 to -100 | 0 to -100dB | 0.00 to 1.00 | Input / Output |
| Meter |  | | | |
| 1-4 | (indicator) | | | Output |
| Mute |  | | | |
| 1-4 | 0  1 | false  true | 0  1 | Input / Output |

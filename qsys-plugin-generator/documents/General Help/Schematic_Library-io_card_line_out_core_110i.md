# Line Out (Core 110f, 110c)

> Source: https://help.qsys.com/Content/Schematic_Library/io_card_line_out_core_110i.htm
...
| --- | --- | --- | --- | --- |
| Analog Level  (Peak Output Level (dBu)) meter | -120 to 24 | -120dB to 24dB | 0.000 to 1.00 | Output |

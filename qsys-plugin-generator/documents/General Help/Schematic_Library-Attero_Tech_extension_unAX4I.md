...
> Source: https://help.qsys.com/Content/Schematic_Library/Attero_Tech_extension_unAX4I.htm

# Attero Tech unAX4I

Use this extension to connect to and control the unAX4I AES67 in-wall I/O interface (Attero Tech by QSC).
...
The extension is compatible with Q-SYS Designer version 8.4 and above and Attero Tech firmware 1.1.1.2 and above. For best results, use the latest [Attero Tech device firmware](https://www.qsys.com/index.php?id=16390).
...
Select the state of phantom power for the input. If the button is gray, the phantom power is inactive. If itâs orange, the phantom power is active. Click the button to toggle between states.
...
| Input Gain | | | | |
| 1, 2, 3, 4 | - | Line (-15dB pad)  Line (no pad)  Low Mic (+25dB)  High Mic (+40dB) | - | Input / Output |

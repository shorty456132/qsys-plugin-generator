...
> Source: https://help.qsys.com/Content/Schematic_Library/Attero_Tech_extension_unA6IOBT.htm
...
Text field indicates the current Bluetooth status. Each status also has a numeric value when using the Status control pin â see [Attero Tech unA6IO-BT](#Control).
...
| Status | 0  1  2 | Idle  Discoverable  Connected (Unknown) | - | Output |
| Device | | | | |

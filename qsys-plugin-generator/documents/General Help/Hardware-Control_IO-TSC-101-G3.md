...
> Source: https://help.qsys.com/Content/Hardware/Control_IO/TSC-101-G3.htm

# TSC-101-G3

The Q-SYS TSC Series Gen 3 are high-performance network touch screen controllers native to Q-SYS. The TSC-101-G3 is a 10.1-inch, PoE-capable (power over Ethernet) device that supports a wide range of fully-customizable user control interface applications for any space.

**Note:** This topic provides an overview of the TSC-101-G3. For specifications and installation documentation, see the [TSC-101-G3 product page](https://www.qsys.com/products-solutions/q-sys/control-io-controllers/q-sys-touch-screen-controllers/tsc-101-g3/) on the QSC website.

[Features](javascript:void(0))

* High performance 10.1-inch network touch screen controller native to the Q-SYS Platform
...
These Inventory components are available for the TSC-101-G3:
...
Product specifications and dimension drawings for the TSC-101-G3 can be found on the [TSC-101-G3 product page](https://www.qsys.com/products-solutions/q-sys/control-touchwall-controllers/q-sys-touch-screen-controllers/tsc-101-g3/) on the QSC website.

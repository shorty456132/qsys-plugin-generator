...
> Source: https://help.qsys.com/Content/Schematic_Library/hdio_gpio_input.htm

# GPIO In (QIO Devices)

Some Q-SYS QIO devices have General Purpose Input pins for extension of Q-SYS Control to third-party devices. In the Q-SYS Designer Software component properties, you can configure the input signal type for each pin â digital, contact closure, potentiometer, analog, or raw.
...
### GPIO-1 to 8 or 4 (depending on device)

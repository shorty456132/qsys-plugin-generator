# Band-Stop Filter Component

> Source: https://help.qsys.com/Content/Schematic_Library/filter_bandstop.htm

# Band-Stop Filter Component

The Band-Stop Filter attenuates a band of frequencies centered around a set frequency.
...
| --- | --- | --- | --- | --- |
| Bandwidth | 0.010 to 3.00 | .010 to 3.00 | 0.000 to 1.00 | Input / Output |
| Bypass | 0  1 | active  bypass | 0  1 | Input / Output |
| Frequency | 10.0 to 20,000 | 10 Hz to 20 kHz | 0.000 to 1.00 | Input / Output |
| Gain | -100 to 0 | -100 dB to 00.0 dB | 0.000 to 1.00 | Input / Output |

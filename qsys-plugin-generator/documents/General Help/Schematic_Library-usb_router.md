...
> Source: https://help.qsys.com/Content/Schematic_Library/usb_router.htm

# USB Router

Use the USB Router component to route input USB [HID Human Interface Device Class](javascript:void(0)) signals to one or more destination peripherals.
...
These pins represent incoming HID signals from up to 16 [USB Input](usb_input.htm) components.

### Output Pins

#### USB Output

These pins represent outgoing, routed HID signals to up to 16 [USB Output](usb_output.htm) components.
...
| --- | --- | --- | --- | --- |
| USB Input *n* | | | | |
| Select | 1 to 16 | 1 to 16 | - | Input / Output |
| USB Output *n* Select | 0  1 | false  true | 0  1 | Input / Output |

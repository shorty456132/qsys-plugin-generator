...
> Source: https://help.qsys.com/Content/Schematic_Library/Attero_Tech_extension_unD6IO.htm

# Attero Tech unD6IO

Use this extension to connect to and control a unD6IO Danteâ¢ Networked Audio Wall Plate (Attero Tech by QSC).

**Note:** See the [unD6IO product page](https://www.qsys.com/systems/products/q-sys-ecosystem/products-peripherals-accessories/attero-tech/at-wall-mount-network-audio-interfaces/und6io/) on the QSC website for product information and documentation.

[Compatibility](javascript:void(0))

The extension is compatible with Q-SYS Designer version 8.4 and above and Attero Tech firmware version 4.5.0 and above. For best results, use the latest Attero Tech firmware.

...
> Source: https://help.qsys.com/Content/Schematic_Library/Attero_Tech_extension_unAX2IOplus.htm

# Attero Tech unAX2IO+

Use this extension to connect to and control the unAX2IO+ AES67 in-wall I/O interface (Attero Tech by QSC).
...
The extension is compatible with Q-SYS Designer version 8.4 and above and Attero Tech firmware 1.2.1.2 and above. For best results, use the latest [Attero Tech device firmware](https://www.qsys.com/index.php?id=16390).

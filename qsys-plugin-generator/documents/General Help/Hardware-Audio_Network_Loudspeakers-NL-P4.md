...
> Source: https://help.qsys.com/Content/Hardware/Audio_Network_Loudspeakers/NL-P4.htm

# NL-P4

The Q-SYS NL-P4 is a network PoE loudspeaker that delivers clear speech and music reproduction natively to Q-SYS. The pendant-mount loudspeaker features a four-inch, full-range driver, optimized for open-ceiling installations. The Q-SYS NL-P4 can be integrated into your space with a single Ethernet cable to reduce overall hardware footprint and lower system cost. As a native Q-SYS Product, you can take advantage of the drag-and-drop integration and simple control capabilities offered by Q-SYS.

**Note:** This topic provides an overview of the NL-P4. For specifications and installation documentation, see the [NL-P4 product page](https://www.qsys.com/products-solutions/q-sys/audio-network-loudspeakers/nl-series/nl-p4/) on the QSC website.
...
These Inventory components are available for the NL-P4:
...
Product specifications and dimension drawings for the NL-P4 can be found on the [NL-P4 product page](https://www.qsys.com/products-solutions/q-sys/audio-network-loudspeakers/nl-series/nl-p4/).

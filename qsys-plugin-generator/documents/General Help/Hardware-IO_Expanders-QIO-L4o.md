...
> Source: https://help.qsys.com/Content/Hardware/IO_Expanders/QIO-L4o.htm

# QIO-L4o

The Q-SYS QIO-L4o is a network audio endpoint native to the Q-SYS Ecosystem, serving as a line output that enables network-based audio distribution. The compact form factor includes surface mounting hardware permitting discreet and strategic mounting while an optional rack kit fits one to four devices into a standard 1U nineteen-inch format. The four-channel granularity locates the right amount of analog audio connectivity in desired locations without bulk or waste. Up to four devices may be daisy-chained off one access switch port, provided 24 VDC power is available. Alternatively, each may be individually powered over Ethernet.

**Note:** This topic provides an overview of the QIO-L4o. For specifications and installation documentation, see the [QIO Series Network Audio Expanders product page](https://www.qsys.com/products-solutions/q-sys/audio-io-peripherals/qio/) on the QSC website.
...
1. Power LED â Illuminates blue when the Q-SYS L4o is powered on
2. ID LED â LED blinks green when placed into ID Mode via ID Button or Q-SYS Designer Software
3. ID Button â Locates the L4o in Q-SYS Designer Software.
...
3. LAN [PoE] â RJ-45 connector, PoE Type 1 Class 2, Q-LAN
...
6. Line Outputs â four channels, balanced or unbalanced â green

[Specifications and Dimensions](javascript:void(0))

Product specifications and dimension drawings for the QIO-L4o can be found on the [QIO Series Network Audio Expanders product page](https://www.qsys.com/products-solutions/q-sys/audio-io-peripherals/qio/).

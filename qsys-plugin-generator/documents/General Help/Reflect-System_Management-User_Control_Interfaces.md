...
> Source: https://help.qsys.com/Content/Reflect/System_Management/User_Control_Interfaces.htm

# User Control Interfaces

View UCIs directly from Q-SYS Reflect (with a Q-SYS Reflect Plus subscription), as well as manage access to the UCIs contained in the design running on the Q-SYS Core processor.
...
To view a UCI directly from Q-SYS Reflect (with a Q-SYS Reflect Plus subscription):
...
**Tip:** Click Open UCI in New Window if you prefer to open the UCI outside of the Q-SYS Reflect window. Or, right-click and select to open the UCI in a new tab.

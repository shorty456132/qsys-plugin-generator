# Low-Shelf Equalizer Component

> Source: https://help.qsys.com/Content/Schematic_Library/equalizer_shelving_low.htm

# Low-Shelf Equalizer Component

The Low-Shelf Equalizer allows you to control the Gain of a group of frequencies below (lower than) an adjustable Frequency. You can also control the slope or transition to the low shelf. At the selected Frequency, the gain changes approximately +3dB or -3dB depending on wether the shelf is adding or reducing gain. Master controls allow you to Bypass, Invert, Mute, and control the Gain of the output of the equalizer.
...
In this example, we have all of our audio channels routed through a series of Equalizers and Filters before being delivered to our Amplifiers. The Low-Shelf Equalizer provides a bass boost or cut.

[Properties](javascript:void(0))

**Tip:** For additional properties that are not listed, refer to the [Properties Panel](../Q-Sys_Designer/properties_panel.htm) help topic for more information.

### Low-Shelf Equalizer Properties
